 ...
 * @return string
 */
function getLinksColumn(array $array = [], string $baseUrl = "", string $idAttribute = 'id', string $titleAttribute = 'title')
{
 ...
 * @return string
 */
function getLinksColumnByRouteName(array $array = [], string $routeName="", string $idAttribute = 'id', string $titleAttribute = 'title')
{
    $html = '<a href="${href}" class="text-bold text-dark">${title}</a>';
    $result = [];
    foreach ($array as $link) {
...
function getArrayColumn(array $array = [], string $titleAttribute = 'title', string $extraClass = '', string $separator = ', ')
{
    $result = [];
    foreach ($array as $link) {
...
function getNeededArray(string $delimiter = '|', string $string = '', $input = "")
{
