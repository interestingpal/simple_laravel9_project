...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Job Statuses</h4>
            </div>
        ...
        @if(count($jobStatuses) == 0)
            <div class="panel-body text-center">
                <h4>No Job Statuses Available.</h4>
            </div>
        @else
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item">
                                            <a href="{{ route('job_statuses.job_status.edit', $jobStatus->id ) }}" class="btn btn-success btn-sm rounded-0" data-toggle="tooltip" data-placement="top" title="Edit" role="button">Edit</a>
